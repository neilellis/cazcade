...
public class RetrievePoolRequest extends AbstractRetrievalRequest {
    public RetrievePoolRequest(final LiquidUUID id, final LiquidSessionIdentifier identity, final LiquidUUID target,
                               final LiquidURI uri, @Nonnull final LiquidRequestDetailLevel detail, final boolean contents,
                               final boolean orCreate, final ChildSortOrder order, final int max) {
        super();
    ...
    public RetrievePoolRequest(@Nullable final LiquidUUID id, @Nullable final LiquidSessionIdentifier identity,
                               @Nullable final LiquidUUID target, @Nullable final LiquidURI uri,
                               @Nonnull final LiquidRequestDetailLevel detail, final boolean contents, final boolean orCreate,
                               @Nullable final ChildSortOrder order) {
        this(id, identity, target, uri, detail, contents, orCreate, order, 50);
    }

    public RetrievePoolRequest(final LiquidSessionIdentifier identity, final LiquidURI uri,
                               @Nonnull final LiquidRequestDetailLevel detail, final boolean contents, final boolean orCreate) {
     ...
     */
    public RetrievePoolRequest(final LiquidSessionIdentifier identity, final LiquidUUID target, final boolean contents,
                               final boolean orCreate) {
        this(null, identity, target, null, LiquidRequestDetailLevel.NORMAL, contents, orCreate, null);
    }

    public RetrievePoolRequest(final LiquidSessionIdentifier identity, final LiquidURI uri, final boolean contents,
                               final boolean orCreate) {
        this(null, identity, null, uri, LiquidRequestDetailLevel.NORMAL, contents, orCreate, null);
    }

    public RetrievePoolRequest(final LiquidURI uri, @Nonnull final LiquidRequestDetailLevel detailLevel, final boolean contents,
                               final boolean orCreate) {
        this(null, null, null, uri, detailLevel, contents, orCreate, null);
    }

    public RetrievePoolRequest(final LiquidSessionIdentifier sessionIdentifier, final LiquidURI uri, final ChildSortOrder sortOrder,
                               final boolean orCreate) {
    ...
    public LiquidMessage copy() {
        return new RetrievePoolRequest(getId(), getSessionIdentifier(), getTarget(), getUri(), getDetail(), isContents(),
                                       isOrCreate(), getOrder()
        );
    }
