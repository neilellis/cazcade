...
public class ResizePoolObjectRequest extends AbstractRequest {
    public ResizePoolObjectRequest(@Nullable final LiquidUUID id, @Nullable final LiquidSessionIdentifier identity,
    ...
    public ResizePoolObjectRequest(final LiquidUUID pool, final LiquidUUID object, final Integer width, final Integer height,
    ...
    public LiquidMessage copy() {
        return new ResizePoolObjectRequest(getId(), getSessionIdentifier(), getUri(), getPoolUUID(), getObjectUUID(), getWidth(),
                                           getHeight()
        );
    }
