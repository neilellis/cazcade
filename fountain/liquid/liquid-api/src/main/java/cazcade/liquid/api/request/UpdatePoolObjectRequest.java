...
public class UpdatePoolObjectRequest extends AbstractUpdateRequest {
    ...
    public UpdatePoolObjectRequest(@Nullable LiquidUUID id, LiquidSessionIdentifier identity, LiquidUUID pool, LiquidUUID target, LSDEntity entity) {
        this.setId(id);
    ...
    @Deprecated
    public UpdatePoolObjectRequest(LiquidURI poolURI, @Nonnull LSDEntity newEntity) {
        this.setUri(newEntity.getURI());
        this.setRequestEntity(newEntity);
    }

    public UpdatePoolObjectRequest(@Nonnull LSDEntity newEntity) {
