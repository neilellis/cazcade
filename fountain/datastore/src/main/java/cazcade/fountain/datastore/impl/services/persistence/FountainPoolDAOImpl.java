...
public class FountainPoolDAOImpl implements FountainPoolDAO {
    ...
    @Override
    @Nonnull
    public LSDPersistedEntity addCommentNoTX(@Nullable final LSDPersistedEntity commentEntity,
                                             @Nonnull final LSDTransferEntity commentTransferEntity,
                                             @Nullable final LiquidURI author) throws InterruptedException {
        fountainNeo.begin();
        try {
    ...
    @Nonnull
    @Override
    public LSDPersistedEntity createPoolNoTx(@Nonnull final LiquidSessionIdentifier identity, @Nonnull final LiquidURI owner,
                                             @Nullable final LSDPersistedEntity parent, @Nonnull final LSDType type,
                                             @Nonnull final String poolName, final double x, final double y,
                                             @Nullable final String title, final boolean listed) throws InterruptedException {
        fountainNeo.begin();
        try {
            if (parent == null) {
    ...
    @Nonnull
    LSDPersistedEntity createView(@Nonnull final LSDPersistedEntity object, @Nonnull final LSDTransferEntity viewEntity)
    ...
    @Nullable
    @Override
    public LSDTransferEntity createPoolObjectTx(@Nonnull final LSDPersistedEntity pool,
                                                @Nonnull final LiquidSessionIdentifier identity, @Nullable final LiquidURI owner,
                                                final LiquidURI author, @Nonnull final LSDTransferEntity entity,
                                                final LiquidRequestDetailLevel detail, final boolean internal,
    ...
    @Nonnull
    public LSDPersistedEntity createPoolObjectNoTx(@Nonnull final LiquidSessionIdentifier identity,
                                                   @Nonnull final LSDPersistedEntity pool, @Nonnull final LSDTransferEntity entity,
                                                   @Nonnull final LiquidURI owner, @Nullable final LiquidURI author,
                                                   final boolean createAuthor) throws InterruptedException {
        fountainNeo.begin();
        try {
    ...
    @Override
    public void createPoolsForCazcadeAliasNoTx(@Nonnull final String name, final String fullName, final boolean systemUser)
            throws InterruptedException {
        createPoolsForAliasNoTx(new LiquidURI("alias:cazcade:" + name), name, fullName, systemUser);
    }

    @Override
    public void createPoolsForAliasNoTx(@Nonnull final LiquidURI aliasURI, @Nonnull final String name, final String fullName,
                                        final boolean systemUser) throws InterruptedException {
        fountainNeo.begin();
        try {
            if (aliasURI.asString().startsWith("alias:cazcade:") && !systemUser) {
                ...
                final LSDPersistedEntity userPool = createPoolNoTx(FountainNeoImpl.SYSTEM_FAKE_SESSION, aliasURI,
                                                                   fountainNeo.getPeoplePool(), name, 0, 0, null, false
                                                                  );
                ...
                final LSDPersistedEntity clipBoardPool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, ".clipboard", 0, 0,
                                                                        null, false
                                                                       );
                clipBoardPool.setAttribute(LSDAttribute.PERMISSIONS, FountainNeoImpl.minimalPermissionNoDeleteValue);

                final LSDPersistedEntity streamPool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, "stream", 210, -210,
                                                                     null, false
                                                                    );
                ...
                final LSDPersistedEntity trashPool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, ".trash", 0, 0, null,
                                                                    false
                                                                   );
                ...
                final LSDPersistedEntity publicPool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, "public", -210, -210,
                                                                     null, false
                                                                    );
                ...
                final LSDPersistedEntity sharedPool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, "friends", -210, 210,
                                                                     null, false
                                                                    );
                ...
                final LSDPersistedEntity privatePool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, "private", 210, 210,
                                                                      null, false
                                                                     );
                ...
                final LSDPersistedEntity profilePool = createPoolNoTx(sessionIdentifier, aliasURI, userPool, "profile", 0, 0, null,
                                                                      true
                                                                     );
    ...
    public void createPoolsForUserNoTx(@Nonnull final String username) throws InterruptedException {
        ...
        try {
            ...
            if (userParentPool == null) {
                userParentPool = createPoolNoTx(new LiquidSessionIdentifier(FountainNeoImpl.SYSTEM, null), cazcadeAliasURI,
                                                fountainNeo.getRootPool(), "users", 0, 0, null, false
                                               );
            }
            final LSDPersistedEntity userPool = createPoolNoTx(new LiquidSessionIdentifier(FountainNeoImpl.SYSTEM, null),
                                                               cazcadeAliasURI, userParentPool, username, 0, 0, null, false
                                                              );
        } finally {
            fountainNeo.end();
        }
    ...
    @Override
    public LSDPersistedEntity createPoolNoTx(@Nonnull final LiquidSessionIdentifier identity, @Nonnull final LiquidURI owner,
                                             final LSDPersistedEntity parent, @Nonnull final String poolName, final double x,
                                             final double y, @Nullable final String title, final boolean listed)
            throws InterruptedException {
        return createPoolNoTx(identity, owner, parent, LSDDictionaryTypes.POOL2D, poolName, x, y, title, listed);
    }

    @Nullable
    public LSDBaseEntity deletePoolObjectTx(@Nonnull final LiquidUUID target, final boolean internal,
    ...
    @Nullable
    LSDTransferEntity deletePoolObjectNoTx(final boolean internal, final LiquidRequestDetailLevel detail,
                                           @Nonnull final Transaction transaction,
                                           @Nonnull final LSDPersistedEntity persistedEntity) throws Exception {
        if (persistedEntity.isDeleted()) {
            throw new DeletedEntityException("The entity %s is already deleted so cannot be deleted again.",
        ...
        final FountainRelationship relationship = persistedEntity.getSingleRelationship(FountainRelationships.CHILD,
                                                                                        Direction.INCOMING
                                                                                       );
        if (relationship == null) {
            throw new OrphanedEntityException("The entity %s is orphaned so cannot be deleted.", persistedEntity.hasAttribute(
                    LSDAttribute.URI
                                                                                                                             )
                                                                                                 ? persistedEntity.getAttribute(
                    LSDAttribute.URI
                                                                                                                               )
                                                                                                 : "<unknown-uri>"
            );
    ...
    @Nullable
    @Override
    public LSDTransferEntity deletePoolObjectTx(@Nonnull final LiquidURI uri, final boolean internal,
                                                final LiquidRequestDetailLevel detail) throws Exception {
        fountainNeo.begin();
        try {
            final Transaction transaction = fountainNeo.beginTx();
    ...
    @Nullable
    public Collection<LSDTransferEntity> getCommentsTx(@Nonnull final LiquidSessionIdentifier identity,
                                                       @Nonnull final LiquidURI uri, final int max, final boolean internal,
        ...
        try {
            ...
            try {
                ...
                for (final org.neo4j.graphdb.Node comment : traverser) {
                    comments.add(convertNodeToEntityWithRelatedEntitiesNoTX(identity, new FountainEntityImpl(comment), null, detail,
                                                                            internal, false
                                                                           )
                                );
                }
    ...
    Traverser getCommentTraverser(@Nonnull final LSDPersistedEntity persistedEntity, final int max) {
        ...
        return persistedEntity.traverse(Traverser.Order.DEPTH_FIRST, new StopEvaluator() {
                                            ...
                                            public boolean isReturnableNode(@Nonnull final TraversalPosition currentPos) {
                                                return currentPos.currentNode().getProperty(LSDAttribute.TYPE.getKeyName()).equals(
                                                        LSDDictionaryTypes.COMMENT.getValue()
                                                                                                                                  );
                                            }
                                        }, VERSION_PARENT, Direction.OUTGOING, COMMENT, Direction.OUTGOING, PREVIOUS,
                                        Direction.OUTGOING
                                       );
    }

    @Nullable
    public LSDBaseEntity getPoolAndContentsNoTX(@Nonnull final LiquidUUID target, final LiquidRequestDetailLevel detail,
                                                final ChildSortOrder order, final boolean contents, final boolean internal,
                                                @Nonnull final LiquidSessionIdentifier identity, final Integer start,
                                                final Integer end, final boolean historical) throws Exception {
        fountainNeo.begin();
        try {
    ...
    @Nullable
    @Override
    public LSDTransferEntity getPoolAndContentsNoTx(@Nonnull final LiquidURI uri, final LiquidRequestDetailLevel detail,
                                                    final ChildSortOrder order, final boolean contents, final boolean internal,
                                                    @Nonnull final LiquidSessionIdentifier identity, final Integer start,
                                                    final Integer end, final boolean historical) throws Exception {
        fountainNeo.begin();
    ...
    @Nullable
    @Override
    public LSDTransferEntity getPoolObjectTx(@Nonnull final LiquidSessionIdentifier identity, @Nonnull final LiquidURI uri,
                                             final boolean internal, final boolean historical,
                                             final LiquidRequestDetailLevel detail) throws InterruptedException {
        fountainNeo.begin();
        try {
            final Transaction transaction = fountainNeo.beginTx();
            try {
                ...
                return convertNodeToEntityWithRelatedEntitiesNoTX(identity, persistedEntity.getLatestVersionFromFork(), parent,
                                                                  detail, internal, historical
                                                                 );
            } catch (RuntimeException e) {
                transaction.failure();
                throw e;
    ...
    public LSDBaseEntity getPoolObjectTx(@Nonnull final LiquidSessionIdentifier identity, @Nonnull final LiquidUUID uuid,
                                         final boolean internal, final boolean historical, final LiquidRequestDetailLevel detail)
            throws InterruptedException {
        fountainNeo.begin();
        try {
            final Transaction transaction = fountainNeo.beginTx();
            try {
                ...
                return convertNodeToEntityWithRelatedEntitiesNoTX(identity, persistedEntity.getLatestVersionFromFork(), null,
                                                                  detail, internal, historical
                                                                 );
            } catch (RuntimeException e) {
                transaction.failure();
    ...
    @Nonnull
    @Override
    public LSDPersistedEntity linkPool(final LSDPersistedEntity newOwner, @Nonnull final LSDPersistedEntity target,
                                       final LSDPersistedEntity from, @Nonnull final LSDPersistedEntity to)
            throws InterruptedException {
        fountainNeo.begin();
        try {
    ...
    public LSDPersistedEntity unlinkPool(@Nonnull final LSDPersistedEntity target) throws InterruptedException {
        fountainNeo.begin();
        try {
            final Iterable<FountainRelationship> relationships = target.getRelationships(FountainRelationships.CHILD,
                                                                                         Direction.INCOMING
                                                                                        );
            for (final FountainRelationship relationship : relationships) {
                relationship.delete();
            }
            final Iterable<FountainRelationship> linkedRelationships = target.getRelationships(FountainRelationships.LINKED_CHILD,
                                                                                               Direction.INCOMING
                                                                                              );
    ...
    @Override
    public LSDPersistedEntity linkPool(final LSDPersistedEntity newOwner, @Nonnull final LSDPersistedEntity target,
                                       @Nonnull final LSDPersistedEntity to) throws InterruptedException {
        fountainNeo.begin();
        try {
...
//            target.createRelationshipTo(newOwner, FountainRelationships.OWNER);
    ...
    @Nonnull
    @Override
    public LSDPersistedEntity linkPoolObject(@Nonnull final LiquidSessionIdentifier editor,
                                             @Nonnull final LSDPersistedEntity newOwner, @Nonnull final LSDPersistedEntity target,
                                             final LSDPersistedEntity from, @Nonnull final LSDPersistedEntity to)
            throws InterruptedException {
        fountainNeo.begin();
        try {
    ...
    @Override
    public LSDTransferEntity linkPoolObjectTx(@Nonnull final LiquidSessionIdentifier editor, @Nonnull final LiquidURI newOwner,
                                              @Nonnull final LiquidURI target, @Nonnull final LiquidURI to,
                                              final LiquidRequestDetailLevel detail, final boolean internal) throws Exception {
        return fountainNeo.doInTransaction(new Callable<LSDTransferEntity>() {
            @Nullable
            @Override
            public LSDTransferEntity call() throws Exception {
                return convertNodeToEntityWithRelatedEntitiesNoTX(editor, linkPoolObject(editor, fountainNeo.findByURI(newOwner),
                                                                                         fountainNeo.findByURI(target),
                                                                                         fountainNeo.findByURI(to)
                                                                                        ),
    ...
    @Nonnull
    @Override
    public LSDPersistedEntity movePoolObjectNoTx(@Nonnull final LiquidURI object, @Nullable final Double x,
                                                 @Nullable final Double y, @Nullable final Double z) throws Exception {
        fountainNeo.begin();
        try {
            final LSDPersistedEntity persistedEntity = fountainNeo.findByURI(object);
    ...
    @Nullable
    @Override
    public LSDTransferEntity selectPoolObjectTx(@Nonnull final LiquidSessionIdentifier identity, final boolean selected,
                                                @Nonnull final LiquidURI target, final boolean internal,
                                                final LiquidRequestDetailLevel detail) throws InterruptedException {
        fountainNeo.begin();
        try {
            ...
            final Transaction transaction = fountainNeo.beginTx();
            try {
                final LSDPersistedEntity persistedEntity = fountainNeo.findByURI(target, true);
    ...
    @Nullable
    @Override
    public LSDTransferEntity getPoolAndContentsNoTx(@Nonnull final LSDPersistedEntity targetPersistedEntity,
                                                    final LiquidRequestDetailLevel detail, final boolean contents,
                                                    final ChildSortOrder order, final boolean internal,
                                                    @Nonnull final LiquidSessionIdentifier identity, @Nullable Integer start,
                                                    @Nullable Integer end, final boolean historical) throws Exception {
        fountainNeo.begin();
        try {
            final LSDPersistedEntity pool = convertToPoolFromPoolOrObject(targetPersistedEntity);
            final LSDTransferEntity entity = convertNodeToEntityWithRelatedEntitiesNoTX(identity, pool, null, detail, internal,
                                                                                        historical
                                                                                       );
            if (contents) {
                ...
                pool.forEachChild(new NodeCallback() {
                    public void call(@Nonnull final LSDPersistedEntity child) throws Exception {
                        final LSDBaseEntity poolObjectEntity = convertNodeToEntityWithRelatedEntitiesNoTX(identity, child, pool,
    ...
    @Nonnull
    LSDPersistedEntity convertToPoolFromPoolOrObject(@Nonnull final LSDPersistedEntity persistedEntityImpl) {
    ...
    @Nullable
    @Override
    public LSDTransferEntity updatePoolObjectNoTx(@Nonnull final LiquidSessionIdentifier identity,
                                                  @Nonnull final LiquidSessionIdentifier editor,
                                                  @Nonnull final LSDTransferEntity entity, @Nullable final LSDPersistedEntity pool,
                                                  @Nonnull final LSDPersistedEntity origPersistedEntity, final boolean internal,
                                                  final LiquidRequestDetailLevel detail) throws InterruptedException {
        final LSDTransferEntity entityCopy = entity.copy();
        ...
        if (!entity.getURI().toString().toLowerCase().equals(origPersistedEntity.getAttribute(LSDAttribute.URI))) {
            throw new CannotChangeURIException("Tried to change the URI of %s to %s", origPersistedEntity.getAttribute(
                    LSDAttribute.URI
                                                                                                                      ),
                                               entity.getURI().toString()
            );
        }
        newObject = convertNodeToEntityWithRelatedEntitiesNoTX(identity, persistedEntity.mergeProperties(entityCopy, true, false,
                                                                                                         new Runnable() {
                                                                                                             @Override
                                                                                                             public void run() {
                                                                                                                 try {
    ...
    @Nonnull
    LSDPersistedEntity copyPoolObjectForUpdate(@Nonnull final LiquidSessionIdentifier editor,
    ...
    @Nullable
    public LSDTransferEntity convertNodeToEntityWithRelatedEntitiesNoTX(@Nonnull final LiquidSessionIdentifier identity,
                                                                        @Nullable final LSDPersistedEntity persistedEntity,
                                                                        @Nullable final LSDPersistedEntity parent,
                                                                        final LiquidRequestDetailLevel detail,
                                                                        final boolean internal, final boolean historical)
            throws InterruptedException {
        fountainNeo.begin();
        try {
            ...
            final LSDTransferEntity entity = persistedEntity.convertNodeToLSD(detail, internal);
            boolean done = false;
            ...
            for (final FountainRelationship relationship : iterable) {
                ...
                entity.addSubEntity(LSDAttribute.VIEW, relationship.getOtherNode(persistedEntity).convertNodeToLSD(detail, internal
                                                                                                                  ), true
                                   );
                done = true;
            }
            ...
            if (detail == LiquidRequestDetailLevel.COMPLETE ||
                ...
                if (ownerRel != null) {
                    entity.addSubEntity(LSDAttribute.OWNER, userDAO.getAliasFromNode(ownerRel.getOtherNode(persistedEntity),
                                                                                     internal, aliasDetailLevel
                                                                                    ), true
                                       );
                }

                if (detail != LiquidRequestDetailLevel.BOARD_LIST) {
                    final FountainRelationship relationship = persistedEntity.getSingleRelationship(FountainRelationships.AUTHOR,
                                                                                                    Direction.OUTGOING
                                                                                                   );
                    if (relationship != null) {
                        entity.addSubEntity(LSDAttribute.AUTHOR, userDAO.getAliasFromNode(relationship.getOtherNode(persistedEntity
                                                                                                                   ), internal,
                                                                                          aliasDetailLevel
                                                                                         ), true
                                           );
                    ...
                    if (editorRel != null) {
                        entity.addSubEntity(LSDAttribute.EDITOR, userDAO.getAliasFromNode(editorRel.getOtherNode(persistedEntity),
                                                                                          internal, aliasDetailLevel
                                                                                         ), true
                                           );
                    }
        ...
        final Traverser traverser = persistedEntity.traverse(Traverser.Order.DEPTH_FIRST, StopEvaluator.END_OF_GRAPH,
                                                             new ReturnableEvaluator() {
                                                                 public boolean isReturnableNode(
                                                                     ...
                                                                     return currentPos.currentNode().hasProperty(
                                                                             LSDAttribute.URI.getKeyName()
                                                                                                                );
                                                                 }
    ...
    @Override
    public void visitNodeNoTx(@Nonnull final LSDPersistedEntity entity, @Nonnull final LiquidSessionIdentifier identity)
            throws InterruptedException {
        fountainNeo.begin();
        try {
            ...
            for (final FountainRelationship relationship : sessionPersistedEntity.getRelationships(FountainRelationships.VISITING,
                                                                                                   Direction.OUTGOING
                                                                                                  )) {
                relationship.delete();
            }
            final LSDPersistedEntity pool = convertToPoolFromPoolOrObject(entity);
            final FountainRelationship relationshipTo = sessionPersistedEntity.createRelationshipTo(pool,
                                                                                                    FountainRelationships.VISITING
                                                                                                   );
