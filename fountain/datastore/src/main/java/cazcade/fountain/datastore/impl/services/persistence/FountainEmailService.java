...
public class FountainEmailService {
    ...
    public void send(@Nonnull final TransferEntity user, @Nonnull final TransferEntity alias, final String templateName, final String subject, final Object data, final boolean test) throws UnsupportedEncodingException {
        ...
        mailService.sendMailFromTemplate(templateName, subject, new String[]{
                user.$(Dictionary.EMAIL_ADDRESS)}, new String[0], new String[0], templateData, test);
    }

    public void sendChangePasswordRequest(@Nonnull final TransferEntity user, final String hash) throws UnsupportedEncodingException {
        ...
        mailService.sendMailFromTemplate("password.vm", "Password change request", new String[]{
                user.$(Dictionary.EMAIL_ADDRESS)}, new String[0], new String[0], templateData, false);
    }

    public void sendRegistrationEmail(@Nonnull final TransferEntity user) throws UnsupportedEncodingException {
    ...
    public void sendWelcomeEmail(final Entity user) {
