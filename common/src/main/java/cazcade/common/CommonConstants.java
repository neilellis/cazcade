...
public interface CommonConstants {
    ...
    @Nonnull String IDENTITY_ATTRIBUTE          = "identity";
    @Nonnull String NEW_USER_ATTRIBUTE          = "newly.registered.user";
    @Nonnull String NEW_USER_PASSWORD_ATTRIBUTE = "newly.registered.user.password";


    @Nonnull String RPC_EXCHANGE    = "rpc-topic";
    @Nonnull String SERVICE_STORE   = "service.store";
    @Nonnull String STRING_ENCODING = "utf-8";
    boolean IS_PRODUCTION = System.getProperty("dev") == null;
    @Nonnull String QUEUE_ATTRIBUTE = "queue";
    @Nonnull String NEO_BACKUP_DIR  = CAZCADE_HOME + "/backup";

    @Nonnull String ANONYMOUS_ALIAS      = "alias:cazcade:anon";
    @Nonnull String CAZCADE_ALIAS_PREFIX = "alias:cazcade:";
