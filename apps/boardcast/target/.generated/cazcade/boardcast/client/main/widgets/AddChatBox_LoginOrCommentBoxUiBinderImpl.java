...
public class AddChatBox_LoginOrCommentBoxUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.boardcast.client.main.widgets.AddChatBox>, cazcade.boardcast.client.main.widgets.AddChatBox.LoginOrCommentBoxUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<span id='{0}'></span> <a id='{1}'>or with Hashbo.</a>")
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final cazcade.boardcast.client.main.widgets.AddChatBox owner) {
   ...
   */
  class Widgets {
    private final cazcade.boardcast.client.main.widgets.AddChatBox owner;


    public Widgets(final cazcade.boardcast.client.main.widgets.AddChatBox owner) {
      this.owner = owner;
     ...
     */
    private cazcade.boardcast.client.main.widgets.AddChatBox_LoginOrCommentBoxUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.boardcast.client.main.widgets.AddChatBox_LoginOrCommentBoxUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.boardcast.client.main.widgets.AddChatBox_LoginOrCommentBoxUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.boardcast.client.main.widgets.AddChatBox_LoginOrCommentBoxUiBinderImpl_GenBundle) GWT.create(cazcade.boardcast.client.main.widgets.AddChatBox_LoginOrCommentBoxUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord64 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();
      get_domId1Element().get();

      // Detach section.
      attachRecord64.detach();
      f_HTMLPanel1.addAndReplaceElement(get_addChatBox(), get_domId0Element().get());
    ...
    /**
     * Getter for addChatBox called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private cazcade.vortex.widgets.client.stream.ChatBox get_addChatBox() {
      return build_addChatBox();
    }
    private cazcade.vortex.widgets.client.stream.ChatBox build_addChatBox() {
      // Creation section.
      final cazcade.vortex.widgets.client.stream.ChatBox addChatBox = (cazcade.vortex.widgets.client.stream.ChatBox) GWT.create(cazcade.vortex.widgets.client.stream.ChatBox.class);
      // Setup section.
      addChatBox.setVisible(false);
      addChatBox.setWidth("100%");
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_loginPanel() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord65 = UiBinderUtil.attachToDom(loginPanel.getElement());
      get_domId2Element().get();
      get_loginLink();

      // Detach section.
      attachRecord65.detach();
