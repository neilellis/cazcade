...
public class VortexStreamEntryPanel_VortexStreamEntryPanelUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel>, cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel.VortexStreamEntryPanelUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<span id='{0}'></span>")
    SafeHtml html1(String arg0);
     
    @Template("<span id='{0}'></span> <div class='stream-entry-main'> <span id='{1}'></span> <div class='stream-entry-details'> <span id='{2}'></span> <span id='{3}'></span> <span id='{4}'></span> </div> </div>")
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel owner) {
   ...
   */
  class Widgets {
    private final cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel owner;


    public Widgets(final cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel owner) {
      this.owner = owner;
     ...
     */
    private cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel_VortexStreamEntryPanelUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel_VortexStreamEntryPanelUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel_VortexStreamEntryPanelUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel_VortexStreamEntryPanelUiBinderImpl_GenBundle) GWT.create(cazcade.vortex.widgets.client.stream.VortexStreamEntryPanel_VortexStreamEntryPanelUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Setup section.
      f_HTMLPanel1.setStyleName("stream-entry-panel");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord62 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      ...
      // Detach section.
      attachRecord62.detach();
      f_HTMLPanel1.addAndReplaceElement(get_imageSurround(), get_domId0Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_text(), get_domId2Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_profileName(), get_domId3Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_location(), get_domId4Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_dateTime(), get_domId5Element().get());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_imageSurround() {
      ...
      // Setup section.
      imageSurround.setStyleName("stream-entry-user-panel");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord63 = UiBinderUtil.attachToDom(imageSurround.getElement());
      get_domId1Element().get();

      // Detach section.
      attachRecord63.detach();
     ...
     */
    private com.google.gwt.user.client.ui.HTML get_text() {
      return build_text();
    }
    private com.google.gwt.user.client.ui.HTML build_text() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTML text = (com.google.gwt.user.client.ui.HTML) GWT.create(com.google.gwt.user.client.ui.HTML.class);
      // Setup section.
      text.setStyleName("stream-entry-message");
    ...
    private com.google.gwt.user.client.ui.Label build_location() {
      ...
      // Setup section.
      location.setStyleName("stream-entry-location");
