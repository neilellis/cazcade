...
public class VortexTextArea_VortexTextAreaUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.vortex.widgets.client.form.fields.VortexTextArea>, cazcade.vortex.widgets.client.form.fields.VortexTextArea.VortexTextAreaUiBinder {
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final cazcade.vortex.widgets.client.form.fields.VortexTextArea owner) {
   ...
   */
  class Widgets {
    private final cazcade.vortex.widgets.client.form.fields.VortexTextArea owner;


    public Widgets(final cazcade.vortex.widgets.client.form.fields.VortexTextArea owner) {
      this.owner = owner;
     ...
     */
    private cazcade.vortex.widgets.client.form.fields.VortexTextArea_VortexTextAreaUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.vortex.widgets.client.form.fields.VortexTextArea_VortexTextAreaUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.vortex.widgets.client.form.fields.VortexTextArea_VortexTextAreaUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.vortex.widgets.client.form.fields.VortexTextArea_VortexTextAreaUiBinderImpl_GenBundle) GWT.create(cazcade.vortex.widgets.client.form.fields.VortexTextArea_VortexTextAreaUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord90 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();
      get_domId1Element().get();
      get_domId2Element().get();

      // Detach section.
      attachRecord90.detach();
      f_HTMLPanel1.addAndReplaceElement(get_textArea(), get_domId0Element().get());
