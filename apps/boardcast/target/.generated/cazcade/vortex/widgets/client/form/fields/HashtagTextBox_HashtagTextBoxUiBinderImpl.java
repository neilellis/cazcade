...
public class HashtagTextBox_HashtagTextBoxUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.vortex.widgets.client.form.fields.HashtagTextBox>, cazcade.vortex.widgets.client.form.fields.HashtagTextBox.HashtagTextBoxUiBinder {
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final cazcade.vortex.widgets.client.form.fields.HashtagTextBox owner) {
   ...
   */
  class Widgets {
    private final cazcade.vortex.widgets.client.form.fields.HashtagTextBox owner;


    public Widgets(final cazcade.vortex.widgets.client.form.fields.HashtagTextBox owner) {
      this.owner = owner;
     ...
     */
    private cazcade.vortex.widgets.client.form.fields.HashtagTextBox_HashtagTextBoxUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.vortex.widgets.client.form.fields.HashtagTextBox_HashtagTextBoxUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.vortex.widgets.client.form.fields.HashtagTextBox_HashtagTextBoxUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.vortex.widgets.client.form.fields.HashtagTextBox_HashtagTextBoxUiBinderImpl_GenBundle) GWT.create(cazcade.vortex.widgets.client.form.fields.HashtagTextBox_HashtagTextBoxUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Setup section.
      f_HTMLPanel1.setStyleName("boardname-textbox");
    ...
    private com.google.gwt.user.client.ui.Label build_errorMessage() {
      ...
      // Setup section.
      errorMessage.setStyleName("form-field-error-message");
