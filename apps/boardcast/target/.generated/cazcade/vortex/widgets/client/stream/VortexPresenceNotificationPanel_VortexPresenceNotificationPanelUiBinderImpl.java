...
public class VortexPresenceNotificationPanel_VortexPresenceNotificationPanelUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel>, cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel.VortexPresenceNotificationPanelUiBinder {
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel owner) {
   ...
   */
  class Widgets {
    private final cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel owner;


    public Widgets(final cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel owner) {
      this.owner = owner;
     ...
     */
    private cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel_VortexPresenceNotificationPanelUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel_VortexPresenceNotificationPanelUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel_VortexPresenceNotificationPanelUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel_VortexPresenceNotificationPanelUiBinderImpl_GenBundle) GWT.create(cazcade.vortex.widgets.client.stream.VortexPresenceNotificationPanel_VortexPresenceNotificationPanelUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord67 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();
      get_text();
      get_domId2Element().get();

      // Detach section.
      attachRecord67.detach();
