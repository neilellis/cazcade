...
public class DirectMessageListEntryPanel_DirectMessageListEntryPanelUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel>, cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel.DirectMessageListEntryPanelUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<span id='{0}'></span>")
    SafeHtml html1(String arg0);
     
    @Template("<span id='{0}'></span> <div class='dm-entry-main'> <span id='{1}'></span> <span class='dm-entry-message' id='{2}'></span> <div class='dm-entry-details'> <span id='{3}'></span> </div> </div>")
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel owner) {
   ...
   */
  class Widgets {
    private final cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel owner;


    public Widgets(final cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel owner) {
      this.owner = owner;
     ...
     */
    private cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel_DirectMessageListEntryPanelUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel_DirectMessageListEntryPanelUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel_DirectMessageListEntryPanelUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel_DirectMessageListEntryPanelUiBinderImpl_GenBundle) GWT.create(cazcade.vortex.widgets.client.panels.list.dm.DirectMessageListEntryPanel_DirectMessageListEntryPanelUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Setup section.
      f_HTMLPanel1.setStyleName("dm-chat-panel");
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_imageSurround() {
      ...
      // Setup section.
      imageSurround.setStyleName("dm-user-panel");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord28 = UiBinderUtil.attachToDom(imageSurround.getElement());
    ...
    private cazcade.vortex.widgets.client.image.UserProfileImage build_profileImage() {
      ...
      // Setup section.
      profileImage.setStyleName("dm-author-icon");
    ...
    private com.google.gwt.user.client.ui.Label build_profileName() {
      ...
      // Setup section.
      profileName.setStyleName("dm-author-label");
    ...
    private cazcade.vortex.widgets.client.date.SelfUpdatingRelativeDate build_dateTime() {
      ...
      // Setup section.
      dateTime.setStyleName("dm-chat-time");
