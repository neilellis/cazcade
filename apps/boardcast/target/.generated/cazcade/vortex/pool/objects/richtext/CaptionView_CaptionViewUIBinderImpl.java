...
public class CaptionView_CaptionViewUIBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, cazcade.vortex.pool.objects.richtext.RichTextView>, cazcade.vortex.pool.objects.richtext.CaptionView.CaptionViewUIBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<span id='{0}'></span> <div style='visibility:hidden;'> <span id='{1}'></span> <span id='{2}'></span> <span id='{3}'></span> </div>")
  ...
  class Widgets {
     ...
     */
    private cazcade.vortex.pool.objects.richtext.CaptionView_CaptionViewUIBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private cazcade.vortex.pool.objects.richtext.CaptionView_CaptionViewUIBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final cazcade.vortex.pool.objects.richtext.CaptionView_CaptionViewUIBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (cazcade.vortex.pool.objects.richtext.CaptionView_CaptionViewUIBinderImpl_GenBundle) GWT.create(cazcade.vortex.pool.objects.richtext.CaptionView_CaptionViewUIBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord53 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();

      // Detach section.
      attachRecord53.detach();
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel2() {
      ...
      // Setup section.
      f_HTMLPanel2.setStyleName("pool-object-caption");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord54 = UiBinderUtil.attachToDom(f_HTMLPanel2.getElement());
      ...
      // Detach section.
      attachRecord54.detach();
      f_HTMLPanel2.addAndReplaceElement(get_label(), get_domId1Element().get());
      f_HTMLPanel2.addAndReplaceElement(get_authorName(), get_domId2Element().get());
      f_HTMLPanel2.addAndReplaceElement(get_location(), get_domId3Element().get());
      f_HTMLPanel2.addAndReplaceElement(get_dateTime(), get_domId4Element().get());
    ...
    /**
     * Getter for label called 1 times. Type: DEFAULT. Build precedence: 3.
     */
    ...
    /**
     * Getter for authorName called 1 times. Type: DEFAULT. Build precedence: 3.
     */
    ...
    /**
     * Getter for location called 1 times. Type: DEFAULT. Build precedence: 3.
     */
    ...
    /**
     * Getter for dateTime called 1 times. Type: DEFAULT. Build precedence: 3.
     */
