...
public class ChecklistPresenter extends AbstractContainerObjectPresenterImpl<ChecklistView> {
    public ChecklistPresenter(PoolPresenter poolPresenter, final LSDEntity entity, final ChecklistView view, VortexThreadSafeExecutor threadSafeExecutor, FormatUtil features) {
